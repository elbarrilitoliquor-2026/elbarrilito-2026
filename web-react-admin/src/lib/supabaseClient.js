/* ============================================================
   SUPABASE CLIENT (React Admin Panel)
   ...
   vanilla-JS admin panel's config at ../js/supabase-config.js and the
   customer React site's config at ../web-react/.env, since all three
   read/write the same `products`, `reviews`, and `whatsapp_clicks`
   tables. Keep them in sync whenever you rotate keys or projects.
   ============================================================ */
...
if (!isConfigured && import.meta.env.DEV) {
  ...
  console.warn(
    '[supabaseClient] VITE_SUPABASE_URL / VITE_SUPABASE_ANON_KEY are not set. ' +
      ...
      '(same project as ../js/supabase-config.js and ../web-react/.env).'
  );
}
...
// calls will simply fail/reject until real keys are supplied.
